...
namespace GiantSquid.Tests
{
    ...
    public class BingoGameShould
    {
        ...
        public void return_second_board_as_the_winner()
        {
            ...
            var secondBoard = new Board(new int[,] { { 3, 15, 0, 2, 22 }, { 9, 18, 13, 17, 5 }, { 19, 8, 7, 25, 23 }, { 20, 11, 10, 24, 4 }, { 14, 21, 16, 12, 6 } });
        ...
        private static Board GivenAnOtherBoard()
      => new Board(new int[,] { { 3, 15, 0, 2, 22 }, { 9, 18, 13, 17, 5 }, { 19, 8, 7, 25, 23 }, { 20, 11, 10, 24, 4 }, { 14, 21, 16, 12, 6 } });
